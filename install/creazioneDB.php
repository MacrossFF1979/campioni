...
// Crea la connessione al server
	...
	//Creazione della tabella Ogggetti nel database
	...
	codeacquisto VARCHAR (255),
	indirizzo VARCHAR(255),
	cap VARCHAR(40),
    cartadicredito VARCHAR(40),
	cvv2 VARCHAR (40)	
	)";
	...
	$sql="INSERT INTO User (nome, cognome, login, email, password, codeacquisto) 
	VALUES ('admin', 'admin', 'admin', 'admin@localhost.it','$password',0);";
	if (mysqli_query($conn, $sql)) {
	echo '<p class="OK">Dati Inseriti</p>';
	} else {
	echo '<p class="warning">Errore inserimento dati</p>' .  mysqli_error($conn);
